        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    @canany(['addc.manage','addc.view'])
                    <li class="nav-item {{ (request()->is('addc')) ? 'active' : '' }}">
                        <a class="nav-link" href="/addc" class="sidelink" style="font-size: 15px;">Check AD Groups</a>
                    </li>
                    @endcanany
                    @can('addc.manage')
                    <li class="nav-item {{ (request()->is('addc/group')) ? 'active' : '' }}">
                        <a class="nav-link" href="/addc/group" class="sidelink" style="font-size: 15px;">Match Groups</a>
                    </li>
                    @endcan
                    @canany(['addc.manage','addc.view'])
                    <li class="nav-item {{ (request()->is('addc/exch')) ? 'active' : '' }}">
                        <a class="nav-link" href="/addc/exch" class="sidelink" style="font-size: 15px;">Mail Features</a>
                    </li>
                    @endcanany
                    <!-- @can('vulner.manage')
                    @endcan
